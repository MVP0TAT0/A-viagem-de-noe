...
func show_nothing_happens_dialog():
	GameState.show_dialog_sequence([
		{"name": "Noé", "text": "Outrora gostava de estar no jardim a tratar das flores...", "color": GameState.cores["noé"]},
		{"name": "Noé", "text": "Mas era o esquisito por também brincar com os insetos...", "color": GameState.cores["noé"]}
