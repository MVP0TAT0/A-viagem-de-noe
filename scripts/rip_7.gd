...
func show_nothing_happens_dialog():
	GameState.show_dialog_sequence([
		{"name": "Noé", "text": "Podia ganhar fosse o que fosse... Podia tirar as melhores notas...", "color": GameState.cores["noé"]},
		{"name": "Noé", "text": "Só servia para ela conseguir encher o peito e cantar para as outras mães...", "color": GameState.cores["noé"]},
