...
func _on_fade_complete():
	...
	GameState.current_level = "mirror"
...
func update_appearance():
	...
	if not GameState.mirror_completed:
		sprite.texture = load("res://assets/ViagemDeNoe/mirror_neutral.png")
	elif GameState.mirror_good_choice:
		sprite.texture = load("res://assets/ViagemDeNoe/mirror_good.png")
	else:
		sprite.texture = load("res://assets/ViagemDeNoe/mirror_bad.png")
