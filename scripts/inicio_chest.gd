...
func show_nothing_happens_dialog():
	...
	GameState.show_dialog_sequence([
		{"name": "Noé", "text": "Cada memória... um peso que carrego.", "color": GameState.cores["noé"]},
		{"name": "Noé", "text": "Esta é a história dela... Mas onde está a minha?", "color": GameState.cores["noé"]}
