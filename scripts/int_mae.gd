...
func show_nothing_happens_dialog():
	...
	GameState.show_dialog_sequence([
		{"name": "", "text": "[font_size=20](Noé olha para a figura fantasmagórica da mãe, ameaçadora e sedutora ao mesmo tempo.)"},
		{"name": "", "text": "[font_size=20](Não percebe o que está a acontecer.)"}
