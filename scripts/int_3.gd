...
func show_nothing_happens_dialog():
	...
	GameState.show_dialog_sequence([
		{"name": "Criança (passado)", "text": "Ele é esquisito, até fala com formigas!", "color": GameState.cores["outro"]},
		{"name": "Noé (susurrar)", "text": "Ao menos os animais não mentem, nem pedem explicações...", "color": GameState.cores["noé"]}
