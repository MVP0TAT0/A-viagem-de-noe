...
func show_nothing_happens_dialog():
	...
	GameState.show_dialog_sequence([
		{"name": "Noé", "text": "Sorrisos educados. Palavras contidas. Sempre quieto, sempre certo.", "color": GameState.cores["noé"]},
		{"name": "Noé", "text": "A minha voz alguma vez me pertenceu?", "color": GameState.cores["noé"]},
		{"name": "Noé", "text": "Eu sou eu mesmo? Ou o que ela queria que eu fosse?", "color": GameState.cores["noé"]}
